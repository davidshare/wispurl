...
setup_otel(service_name=os.getenv("OTEL_SERVICE_NAME", "auth-service"))
...
async def handle_auth_domain_error(
    ...
    if isinstance(exc, AuthDomainError):
...
def create_app() -> FastAPI:
    ...
    app.add_exception_handler(AuthDomainError, handle_auth_domain_error)
    ...
    logger.info("auth_service_configured")
    return app
